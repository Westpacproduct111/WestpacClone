              ...
              <div className="mb-4 flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      <a href="https://www.westpac.com.au/personal-banking/home-loans/investing-in-property/?fid=hp:product:hl:subhead:wbc:www:pers:home-loans:investing-in-property" className="text-sm text-foreground hover:underline" data-testid="link-invest-property">
                        Invest in property
                      </a>
                    </li>
                  </ul>
              ...
              <div className="mb-4 flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      <a href="https://www.westpac.com.au/personal-banking/credit-cards/low-fee/?fid=HP:product:cc:subhead:wbc:www:pers:credit-cards:low-fee" className="text-sm text-foreground hover:underline" data-testid="link-low-fee-card">
                        Low fee credit card
                      </a>
                    </li>
                  </ul>
